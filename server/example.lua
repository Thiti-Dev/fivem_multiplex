...
MySQL.ready(function ()
        ...
        MySQL.Async.fetchAll("SELECT character_name FROM users WHERE username = 'thiti' ", {}, function (result)
        print("the length of data is : ", #result)
    ...
    --print(MySQL.Sync.fetchScalar("SELECT character_name FROM users WHERE username = 'thiti' "))
